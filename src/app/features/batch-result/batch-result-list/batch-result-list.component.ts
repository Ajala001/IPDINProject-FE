...
import { BatchResultService } from '../../../core/services/batch-result/batch-result.service';
import { AuthService } from '../../../core/services/auth/auth.service';
import { BatchResultResponseDto } from '../../../shared/models/interfaces/resultResponse';
import { pagedResponse } from '../../../shared/models/interfaces/pagedResponse';
import { SearchQueryModel } from '../../../shared/models/classes/searchQuery';
  ...
  getBatchResults() {
    ...
    this.batchResultService.getBatchResults(params).subscribe((response: pagedResponse) => {
      if (response.isSuccessful) {
        ...
        debugger;
        debugger;
        this.router.navigateByUrl("batch-results");
      } else {
